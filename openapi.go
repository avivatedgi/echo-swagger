...
type OpenAPI struct {
	...
	OpenAPI string `yaml:"openapi" validate:"required"`
	...
	Path map[string]Path `yaml:"path" validate:"required"`
...
type Info struct {
	...
	Contact InfoContact `yaml:"contact"`

	// The license information for the exposed API.
	License InfoLicense `yaml:"license"`
...
type Parameter struct {
	...
	Reference string `yaml:"$ref" validate:"required_without=Name In Description Required Deprecated AllowEmptyValue"`
	...
	In string `yaml:"in" yaml:"oneof=query header path cookie"`
...
type RequestBody struct {
	// A simple object to allow referencing other components in the specification, internally and externally.
	Reference string `yaml:"$ref" validate:"required_without=Content Description Required"`
...
type Schema struct {
	// A simple object to allow referencing other components in the specification, internally and externally.
	Reference string `yaml:"$ref" validate:"required_without=Nullable Discriminator ReadOnly WriteOnly ExternalDocumentation Example Deprecated"`
	...
	ExternalDocumentation ExternalDocumentation `yaml:"externalDocs"`
...
type Discriminator struct {
	...
	PropertyName string `yaml:"propertyName" validate:"required"`
...
type Example struct {
	// A simple object to allow referencing other components in the specification, internally and externally.
	Reference string `yaml:"$ref" validate:"required_without=Summary Description Value ExternalValue"`
...
type Header struct {
	// A simple object to allow referencing other components in the specification, internally and externally.
	Reference string `yaml:"$ref" validate:"required_without=Description Required Deprecated AllowEmptyValue"`
...
type Link struct {
	...
	OperationReference string `yaml:"operationRef"`
